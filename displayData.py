...
# Method displays the confirmed, deaths, recovered cases for the selected country;
# Display special features for the world. It will be slightly different from the country's GUI.
# Thus requires it's own method.
def display_World():
    ...
    print("Selected: WorldWide")

    # Populate displayValues dictionary with the statistics for the world.
    ...
    # Display these statistics in the tkinter GUI.
    ...
    label.pack()
    label1 = tk.Label(frame, text="WORLDWIDE", background=countryBG, font=("Courier", 26, "bold"))
...
def display_Country(countryCode):
